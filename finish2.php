...
<head>
  ...
  <meta property="og:image"         content="https://www.invyt.in/uploads/<?php echo $i_url; ?>" />
        ...
        <div class="features-content-container features-content-container-left web-stories">
            ...
            <center>
              <div class="copy-link-inner">
                ...
                <button type="submit"  name="submit"  id="submit" class="btn btn--purple btn--width">View Invyt</button>
            </div>
            </center>
            </div>
        </div>
