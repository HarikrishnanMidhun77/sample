 ...
 <section class="features landing-web-stories">
    <div class="features-container-shell clearfix">
        <div class="features-content-container features-content-container-left web-stories">
            ...
            <div class="features-content">
             ...
             <!-- <form action="payreq.php" method="post">
              <div class="form-group">
                 <input type="text" name="p_name"  placeholder="Name of payer" class="form__field form__text" required></input>
              </div>
            <div class="form-group">
                <input type="text" name="p_email"  placeholder="Email ID of payer" class="form__field form__text" required></input>
            </div>
            <div class="form-group">
                <input type="text" name="p_phno"  placeholder="Phone Number of payer" class="form__field form__text" required></input>
            </div>
            <br>
            <center>
            <div class="site__box-link">
                <button type="submit" class="btn btn--purple btn--width" >Pay</button>
            </div>
            <br><br>
            </center>
            </form>-->
            <center>
            <div class="site__box-link">
                <a href="payreq.php" class="btn btn--purple btn--width" >Pay Now</a>
            </div>
            <br><br>
            </center>
            </div>
        ...
        <div class="device features-device-right web-stories">
            <div class="site">
            <img class="site__img" src="img/pay.svg">
            </div>
        </div> 
    </div>
</section>   
